    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="I'm Paul Grimaldo"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">I&apos;m Paul Grimaldo</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              {' '}
              A software engineer based on what you need, backend, frontend or mobile development. I spend my days (and often nights) learning new technologies and new ways to solve the complex problems that companies need to solve.
              Take a look into the{' '}
              <Link href="/projects" aria-label="Go to Projects Page">
                Projects
              </Link>{' '}
              and see on what type of projects I was working in the past years,{' '}
            </motion.p>
            <motion.p {...getTransitions(0.5)}>
             ...
             <Link href="/contact" aria-label="Go to Contact Page">
              ...
              {' '} 
             and we can have a brief meeting in which you can tell me all the needs you have and how I can help you with each of them, so we can work together on all the projects you need 🙌🏽.
            </motion.p>
          </article>
